...
/**
 * Класс описывает работу простейшей очереди по приоритету, которая работает по принципу FIFO (first
 * in - first out)
 *
...
public class PriorityQueue {
    ...
    /**
     * Метод принимает на вход заявку и добавляет ее в очередь. Если встречаются 2 задания с
     * одинаковым приоритетом, то в очереди они распределяются по принципу FIFO.
     *
